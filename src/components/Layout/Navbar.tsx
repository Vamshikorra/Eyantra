        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <div className="ml-4 flex items-center">
              ...
              <div className="ml-3">
                <h1 className="text-xl font-bold text-gray-900">e-Yantra</h1>
                <p className="text-xs text-gray-500">NIT Andhra Pradesh</p>
              </div>
            </div>
          </div>
                ...
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 py-2">
                  ...
                  <div className="max-h-64 overflow-y-auto">
                    <div className="px-4 py-3 hover:bg-gray-50 cursor-pointer">
                      <p className="text-sm text-gray-900">New workshop announced</p>
                      <p className="text-xs text-gray-500">2 minutes ago</p>
                    </div>
                    <div className="px-4 py-3 hover:bg-gray-50 cursor-pointer">
                      <p className="text-sm text-gray-900">Achievement posted</p>
